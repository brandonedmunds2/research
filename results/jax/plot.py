...
data2=pandas.read_excel("./results/new/AuditResults.xlsx",1).fillna("")
...
descs=['Eps3',
       'Augmentation',
       'First Conv Magnitude Prune',
       'Second Conv Magnitude Prune',
       'First Block Conv Magnitude Prune',
       'Last Block Conv Magnitude Prune',
       'Last Conv Magnitude Prune',
       'Last Block First Conv Magnitude Prune'
       ]
all_plot(data,descs,axs1)

fig2,axs2=plt.subplots(2,3)
for i,desc in enumerate(descs[2:]):
    dual_y_plot(data,desc,axs2[i//3,i%3])
